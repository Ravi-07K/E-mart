...
public class ViewReceptionistFrame extends javax.swing.JFrame {
    ...
    private void showReceptionistData() {
         try{
            List<ReceptionistPojo> rcpList=ReceptionistDAO.getAllReceptionist();
            DefaultTableModel tm=(DefaultTableModel)jtAllRcp.getModel();
            Object[] rows=new Object[5];
            for(ReceptionistPojo rcp:rcpList){
                rows[0]=rcp.getEmpid();
                rows[1]=rcp.getEmpname();
                rows[2]=rcp.getUserid();
                rows[3]=rcp.getJob();
                rows[4]=rcp.getSalary();
               tm.addRow(rows);
            }            
        }
