...
public class RemoveReceptionistFrame extends javax.swing.JFrame {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(cmbRcpId, javax.swing.GroupLayout.PREFERRED_SIZE, 145, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoveActionPerformed
        ...
        boolean result=ReceptionistDAO.deleteReceptionist(rcpid);
        if(!result){
    ...
    private void loadReceptionistId() {
         try{
            ArrayList<String> rcp=(ArrayList<String>) ReceptionistDAO.getAllReceptionistUserId();
            if(rcp.isEmpty()){
